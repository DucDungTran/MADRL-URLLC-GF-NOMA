...
class D3QN():
    ...
    def build_model(self):
        ...
        state_value = Dense(1)(h3)
        action_advantage = Dense(self.n_actions)(h3)
        outp = state_value + (action_advantage - tf.math.reduce_mean(action_advantage, axis=1, keepdims=True))
